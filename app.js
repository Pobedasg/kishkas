...
const USERS = {
  vika:{
    ...
    heroTitle:'Від блокеру<br>до <span style="color:var(--ac)">публікації</span>',
  ...
  aluna:{
    ...
    heroTitle:'Живи зараз.<br><span style="color:var(--ac)">Знімай завжди.</span>',
  ...
  dodo:{
    ...
    heroTitle:'Кожна робота —<br><span style="color:var(--ac)">це контент.</span>',
